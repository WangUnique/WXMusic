...
__DEFINE__(1652687250868, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1652687250869,"./event-store":1652687250870}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652687250869, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1652687250870, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1652687250869,"./utils":1652687250871}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652687250871, function(require, module, exports) {
...
return __REQUIRE__(1652687250868);
})()
